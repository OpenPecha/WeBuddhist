...
import {getEarlyReturn, mapLanguageCode} from "../../utils/helperFunctions.tsx"; 
import Seo from "../commons/seo/Seo.tsx";

export const fetchSubCollections = async (parentId: string) => {
...
const SubCollections = (props: any) => {
